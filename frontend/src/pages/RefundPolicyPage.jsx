...
export default function RefundPolicyPage() {
    return (
        <div className="min-h-screen bg-[#0d1b4b] text-white">
            <Helmet>
                <title>Refund Policy | Target Zone Library</title>
                <meta name="description" content="Refund policy for Target Zone Library membership plans — eligibility, timelines, and how to request a refund." />
                <link rel="canonical" href="https://targetzone.co.in/refund-policy" />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://targetzone.co.in/refund-policy" />
                <meta property="og:title" content="Refund Policy | Target Zone Library" />
                <meta property="og:description" content="Refund policy for Target Zone Library membership plans — eligibility, timelines, and how to request a refund." />
