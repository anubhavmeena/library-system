...
extension Color {
    ...
    // Expiry-view seat map tiers + gender coloring — matches the web admin
    // seat map's tailwind palette (orange-500, yellow-500, red-950, fuchsia-500)
    static let orange       = Color(hex: 0xF97316)
    static let orangeFaint  = Color(hex: 0xF97316, alpha: 0.15)
    static let yellowWarn   = Color(hex: 0xEAB308)
    static let yellowFaint  = Color(hex: 0xEAB308, alpha: 0.15)
