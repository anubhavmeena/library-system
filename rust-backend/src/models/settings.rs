...
pub const NOTIFICATION_CATALOG: &[NotificationCatalogEntry] = &[
    ...
    NotificationCatalogEntry { key: "USER_REGISTERED", default_send_to_student: true, default_send_to_admin: false, student_editable: true, admin_editable: true, hindi_editable: true, default_hindi_text_student: None, default_hindi_text_admin: None },
    ...
    NotificationCatalogEntry { key: "ADMIN_BROADCAST", default_send_to_student: true, default_send_to_admin: false, student_editable: false, admin_editable: false, hindi_editable: false, default_hindi_text_student: None, default_hindi_text_admin: None },
